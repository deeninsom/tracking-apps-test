...
export class UserLocationController {
  ...
  async createLocationUserV2(
    ...
    try {
      const { userId, lat, lng, isActive, speed, isDriving } = body;
      const newLocationUser = await this.userLocationService.createLocationUserV2(userId, lat, lng, isActive, speed, isDriving);
